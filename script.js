document.addEventListener('DOMContentLoaded', function () {
    const sheetId = '1pkVkz_GhrN1HbsppkGSlMOOE4Jluv4naqFXUm9-zHd4';
    ...
    fetch(url)
        ...
        .then(rep => {
            ...
            downloadPdf.addEventListener('click', function () {
                ...
                printWindow.document.write('<h1>Datos de asistencias Mecanica del Automotor Modulo -III 2024</h1>');
